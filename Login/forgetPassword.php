   ...
   <div id="error" style="color:red; font-size:16px; font-weight:bold; padding:5px"></div>
    <table style="width:100%; margin-right:2rem; border-spacing:0.5rem;">
        <thead></thead>
        <tbody>
            <tr>
                <td style="text-align: right;font-size: 20px">Email</td>
                <td style="font-size: 20px"><input type="text" name="email" id="fname" onkeydown="HideError()" size="20px;"/></td>
            </tr>
            <tr>
