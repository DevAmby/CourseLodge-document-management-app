...
<html>
    <head>
        <title>CourseLodge | Home Page</title>
    ...
    <body>
        <div id="wrap">
            <div id="header">
                <div id="logo">
                    <h1 style="text-align: center;color: black;"><span><img src="image/Address Book.png" alt="logo"/></span>CourseLodge E-signature </h1>  
                </div>
                </div>
            <div id="menu">
                <ul>
