...
<form name="Myform" id="Myform" action="User/RegisterProcess.php" method="post" onsubmit="return(Validate());">
   <div id="error" style="color:red; font-size:16px; font-weight:bold; padding:5px"></div>
    <table style="width:50%; margin-left: 14em; border-spacing: 0.5rem;">
        <thead></thead>
        <tbody>
            <tr>
                <td>First name</td>
            ...
            <tr>
                <td>Phone number</td>
                <td><input type="text" name="mobile" id="mobile" maxlength="12" onkeydown="HideError()"/></td>
            </tr>
            <tr>
                <td>Email address</td>
            ...
            <tr>
                <td>Password</td>
                <td><input type="password" name="psw" id="password" onkeydown="HideError()"/></td>
            </tr>
            <tr>
                <td>User Type</td>
                <td>
